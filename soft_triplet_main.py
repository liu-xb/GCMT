...
from gcc.soft_triplet_trainer import SoftTripletTrainer 
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # Trainer
        trainer = SoftTripletTrainer(model_list, model_ema_list, num_cluster=args.num_clusters, alpha=args.alpha)
